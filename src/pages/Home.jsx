        ...
        <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center flex-grow py-12">
          ...
          <div className="flex flex-col items-start z-10 text-center lg:text-left">
            ...
            <h1 className="text-5xl lg:text-6xl font-extrabold leading-tight mb-6">
              ...
              <br className="hidden lg:block" /> Learn, Grow & Lead
            </h1>

            {/* HIGHLIGHTED NEXTGEN ONLY HERE */}
            <p className="text-lg text-white/70 mb-10 max-w-lg mx-auto lg:mx-0 leading-relaxed">
              <span className="text-brand-accent font-bold">NextGen</span> Skill
              EduHub offers career counselling, skill development, communication
              training, and study materials for students and professionals in
              Bangalore.
            </p>
            ...
            <div className="flex flex-col gap-4 w-full sm:w-auto">
              <Link
                to="/contact"
                className="bg-brand-accent text-center text-brand-dark px-8 py-4 rounded-full font-bold text-lg hover:bg-white hover:-translate-y-1 transition-all"
              >
                Get Counselling
              </Link>
            </div>
          ...
          <div className="relative hidden lg:flex justify-center items-center h-full">
            ...
            <div className="relative z-10 w-full max-w-md bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-10 shadow-2xl animate-float">
              ...
              <div className="text-xs text-brand-accent mt-4">
        ...
        <div className="w-full bg-black/20 border-t border-white/10 py-8">
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center max-w-4xl mx-auto">
              {[
                { num: 12, label: "Students Guided", suffix: "k+" },
                { num: 50, label: "Expert Mentors", suffix: "+" },
          ...
          <div className="flex flex-col lg:flex-row-reverse items-center gap-16 lg:gap-24">
            ...
            <div className="flex-1">
              ...
              <h2 className="text-5xl font-extrabold text-brand-dark mb-6 leading-tight">
                Not just a platform. <br /> An{" "}
                <span className="text-brand-accent">Ecosystem.</span>
              </h2>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                NextGen Skill EduHub bridges the gap between traditional
                education and industry demands. We don't just teach; we align
                your skills, academics, and career path into one seamless
                journey.
              </p>
            ...
            <div className="flex-1 relative">
              ...
              <div className="relative rounded-[3rem] overflow-hidden shadow-2xl border-4 border-white/50">
                <img
                  ...
                  className="w-full h-auto object-cover hover:scale-105 transition duration-500 ease-in-out"
                />
              </div>
        ...
        <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 relative z-10 items-center">
          <div className="text-left">
            ...
            <p className="text-blue-100/60 text-lg leading-relaxed max-w-md">
              The foundation of our integrated ecosystem designed for student
              success.
            </p>
          </div>
        ...
        <div className="container mx-auto px-6 max-w-6xl relative z-10">
          <div className="text-center max-w-2xl mx-auto mb-20">
            ...
            <p className="text-gray-500 text-lg">
              We combine human expertise with technology to deliver results.
            </p>
          </div>
            ...
            {[
              {
                ...
                points: [
                  "Backed by experienced counsellors",
                  "Frameworks for all age groups",
                ],
              },
              {
                img: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=800&q=80",
                stat: "360°",
                desc: "The complete success loop.",
                label: "Methodology",
              ...
              },
              {
                ...
                stat: "100%",
                desc: "Transparent progress tracking.",
                label: "Results",
              ...
              <div
                key={idx}
                className={`flex flex-col ${item.reverse ? "lg:flex-row-reverse" : "lg:flex-row"} gap-16 items-center group`}
              >
                <div className="flex-1 relative w-full h-[400px]">
                  ...
                  <img
                    src={item.img}
                    alt={item.title}
                    className="w-full h-full object-cover rounded-3xl shadow-lg group-hover:scale-[1.02] transition-transform duration-500 brightness-95 group-hover:brightness-100"
                  />

                  <div
                    className={`absolute bottom-8 ${item.reverse ? "-right-8" : "-left-8"} bg-white/80 backdrop-blur-md border border-white/90 p-5 rounded-2xl shadow-xl max-w-[240px] animate-float hidden md:block group-hover:shadow-2xl transition-all`}
                  >
                ...
                <div className="flex-1">
                  ...
                  <div className="space-y-3">
                    {item.points.map((pt, pIdx) => (
                      <div
                        key={pIdx}
                        className="flex items-center gap-3 font-semibold text-brand-dark"
                      >
                        <span className="w-6 h-6 rounded-full bg-brand-accent/20 text-brand-accent flex items-center justify-center text-xs shadow-sm">
                          ✓
                        </span>
                        {pt}
                      </div>
