...
import { 
  ...
  Linkedin, Instagram, Facebook, Globe, CheckCircle2, AlertCircle
} from 'lucide-react';
      ...
      <section className="relative h-[60vh] min-h-[500px] flex items-center justify-center">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold text-white mb-6 leading-tight">
             Your Next Big Leap <br/> <span className="text-white/95">Starts With a Hello.</span>
          </h1>
          <p className="text-xl text-white/80 max-w-2xl mx-auto font-light leading-relaxed">
            Expert guidance for students, professionals, and institutions ready to redefine their potential.
          </p>
        </div>
      </section>
              ...
              <div className="lg:col-span-2 bg-[#12103a] p-10 md:p-16 text-white relative overflow-hidden flex flex-col justify-between">
                ...
                <div className="relative z-10">
                  <h2 className="text-3xl md:text-4xl font-extrabold mb-6 leading-tight">
                    Send us a <br/><span className="text-brand-accent">Message.</span>
                  </h2>
                  <p className="text-blue-100/70 mb-12 leading-relaxed text-lg">
                    Whether you are a student looking for clarity, a professional seeking growth, or an institution planning a partnership—we'd love to hear from you.
                  </p>
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="flex items-center gap-5">
                      ...
                      <div>
                        ...
                        <p className="text-white/60">Available 9 AM - 6 PM IST</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="pt-12 mt-12 border-t border-white/10 relative z-10">
                  <h4 className="font-bold mb-6 uppercase text-xs tracking-widest text-brand-accent">Connect With Us</h4>
                  <div className="flex gap-4">
                    {[Linkedin, Instagram, Facebook, Globe].map((Icon, i) => (
                      <a key={i} href="#" className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-brand-accent hover:text-[#12103a] transition-all duration-300">
                        <Icon size={22} />
                      </a>
                    ))}
                  </div>
              ...
              <div className="lg:col-span-3 p-10 md:p-16 bg-white relative">
                ...
                {isSuccess && (
                  <div className="absolute inset-0 bg-white/90 backdrop-blur-sm z-50 flex flex-col items-center justify-center text-center p-8 animate-fadeIn">
                    ...
                    <p className="text-gray-500 max-w-md">Thank you for contacting us. Our team will get back to you within 24 hours.</p>
                    <button onClick={() => setIsSuccess(false)} className="mt-8 px-8 py-3 bg-brand-dark text-white rounded-xl font-bold hover:bg-brand-accent hover:text-brand-dark transition-all">
                      Send Another
                    </button>
                  </div>
                )}
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-gray-700 ml-1">First Name <span className="text-red-500">*</span></label>
                      <input 
                        type="text" 
                        name="firstName"
                      ...
                      />
                      {errors.firstName && <p className="text-red-500 text-xs ml-1 flex items-center gap-1"><AlertCircle size={12}/> {errors.firstName}</p>}
                    </div>
                    <div className="space-y-2">
        ...
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-10 rounded-[2rem] shadow-lg border border-gray-100 group hover:-translate-y-2 transition-all duration-300 text-center">
              ...
              <a href="mailto:mail@nextgenedu.in" className="text-brand-accent font-bold text-lg hover:underline decoration-2 underline-offset-4">mail@nextgenedu.in</a>
            </div>
            ...
            <div className="bg-white p-10 rounded-[2rem] shadow-lg border border-gray-100 group hover:-translate-y-2 transition-all duration-300 text-center">
              ...
              <a href="tel:+917795980263" className="text-brand-accent font-bold text-lg hover:underline decoration-2 underline-offset-4">+91 77959 80263</a>
            </div>
